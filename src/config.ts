...
export const siteConfig: SiteConfig = {
	title: "Kiocou",
	subtitle: "Hellow   Kiocou",
	siteURL: "https://kiocou.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-11-24", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	themeColor: {
		hue: 165, // 主题色的默认色相，范围从 0 到 360。海沫绿：165
	...
	links: [
...

		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/kiocou",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/567630629",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/zhoshusheng",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	...
	name: "KioCou",
	bio: " 我是 kioco！喜欢折腾代码、探索实用工具，也爱记录生活里的小灵感。",
	typewriter: {
...
export const umamiConfig = {
	...
	apiKey:
		import.meta.env.UMAMI_API_KEY || "api_W6ZCcK1AmKjI9bLUMgRL7NhnYRqb3mSY", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="5d139753-e8c8-4e1d-a2b3-29b97cd98dfb"></script>
